...
@Mapper
interface TransactionSourceModelMapper {
    ...
    fun insert(insertStatement: InsertStatementProvider<TransactionSourceModelRecord>): Int

    @InsertProvider(type=SqlProviderAdapter::class, method="insertMultiple")
    fun insertMultiple(multipleInsertStatement: MultiRowInsertStatementProvider<TransactionSourceModelRecord>): Int

    @SelectProvider(type=SqlProviderAdapter::class, method="select")
    @ResultMap("TransactionSourceModelRecordResult")
    fun selectOne(selectStatement: SelectStatementProvider): TransactionSourceModelRecord?

    @SelectProvider(type=SqlProviderAdapter::class, method="select")
    @Results(id="TransactionSourceModelRecordResult", value = [
    ...
    fun selectMany(selectStatement: SelectStatementProvider): List<TransactionSourceModelRecord>
