...
@Mapper
interface TransactionParticipantModelMapper {
    ...
    fun insert(insertStatement: InsertStatementProvider<TransactionParticipantModelRecord>): Int

    @InsertProvider(type=SqlProviderAdapter::class, method="insertMultiple")
    fun insertMultiple(multipleInsertStatement: MultiRowInsertStatementProvider<TransactionParticipantModelRecord>): Int

    @SelectProvider(type=SqlProviderAdapter::class, method="select")
    @ResultMap("TransactionParticipantModelRecordResult")
    fun selectOne(selectStatement: SelectStatementProvider): TransactionParticipantModelRecord?

    @SelectProvider(type=SqlProviderAdapter::class, method="select")
    @Results(id="TransactionParticipantModelRecordResult", value = [
        ...
        Result(column="time_inserted", property="timeInserted", jdbcType=JdbcType.BIGINT),
    ...
    fun selectMany(selectStatement: SelectStatementProvider): List<TransactionParticipantModelRecord>
