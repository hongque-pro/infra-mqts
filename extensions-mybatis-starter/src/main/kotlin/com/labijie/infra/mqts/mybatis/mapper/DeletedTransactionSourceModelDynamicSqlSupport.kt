...
object DeletedTransactionSourceModelDynamicSqlSupport {
    object DeletedTransactionSourceModel : SqlTable("`mqts_sources_deleted`") {
        ...
        val data = column<ByteArray>("`data`", JDBCType.LONGVARBINARY)
